...
def addsitepackages(known_paths):
    ...
    setuptools_path = '/net/bao.sn.auf/home/francis.ngatsi/public_html/rigl/eggs/distribute-0.6.27-py2.6.egg'
    ...
    original_paths = [
        '/usr/local/lib/python2.6/dist-packages/Whoosh-0.3.18-py2.6.egg',
